    ...
    with st.form("Select One Demographics and One Rating"):
        ...
        if submitted:
            fig10 =  px.box(starbucks_merged,x="avg_amt_spent", y =factors_dic[colorrating_col],
                            ...
                            category_orders = category_orders_dict,  color_discrete_sequence=['#82b74b', '#036635','#c1946a', '#3e4444'],height=550, width = 550, hover_data=["annual_income", "visit_frequency"])
